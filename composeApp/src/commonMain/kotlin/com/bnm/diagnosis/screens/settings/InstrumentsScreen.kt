...
import com.bnm.diagnosis.instruments.INSTRUMENT_DRIVERS
...
import com.bnm.diagnosis.instruments.driverFor
import com.bnm.diagnosis.instruments.listSerialPorts
import com.bnm.diagnosis.instruments.serialSupported
...
@Composable
private fun statusLine(s: com.bnm.diagnosis.instruments.InstrumentStatus?): String = when {
    s == null -> "Starting…"
