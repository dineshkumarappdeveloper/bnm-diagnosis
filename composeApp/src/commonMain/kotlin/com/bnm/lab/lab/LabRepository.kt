...
import com.bnm.lab.db.Emr_inbox
import com.bnm.lab.db.Lab_order_tests
import com.bnm.lab.db.Lab_orders
import com.bnm.lab.db.Lab_panels
import com.bnm.lab.db.Lab_reports
import com.bnm.lab.db.Lab_results
import com.bnm.lab.db.Lab_tests
import com.bnm.lab.db.OpenOrders
import com.bnm.lab.db.Patients
...
class LabRepository(
     ...
     */
    suspend fun backfillSignatoryIds(staff: List<com.bnm.lab.staff.Staff>, defaultOwnerId: String) =
        withContext(Dispatchers.Default) {
    ...
    private fun com.bnm.lab.db.Lab_result_graphs.toGraph() = ResultGraph(
