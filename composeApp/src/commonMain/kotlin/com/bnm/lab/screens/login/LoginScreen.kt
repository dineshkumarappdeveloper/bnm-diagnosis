package com.bnm.lab.screens.login
...
import com.bnm.lab.auth.AdminUser
...
fun LoginScreen(
    ...
    fun pairDevice() {
        ...
        errorMessage = null
        scope.launch {
            val res = authRepository.pairWithCode(code = c, token = null, deviceId = deviceId, deviceName = "BNM Lab counter")
            res.onSuccess { pr ->
