...
import com.bnm.diagnosis.instruments.Hl7Ack
import com.bnm.diagnosis.instruments.Hl7Delimiters
import com.bnm.diagnosis.instruments.Hl7Escape
import com.bnm.diagnosis.instruments.Hl7Message
...
class Hl7Test {
    ...
    fun ackIsByteExact() {
        ...
        assertEquals("MSH|^~\\&|BNMDiagnosis||||20260908120000||ACK^R01|7|P|2.3.1||||||UNICODE\rMSA|AA|1\r", ack)
        assertEquals("", rest)
    }
    ...
    fun ackErrorCodeAndSenderEcho() {
        ...
        assertEquals("MSH|^~\\&|BNMDiagnosis||BC-5130|LabA|20260908120001||ACK^R01|9|Q|2.3.1||||||UNICODE\rMSA|AE|555\r", ack)
    ...
    fun ackEventFollowsReceivedType() {
        ...
        assertEquals("MSH|^~\\&|BNMDiagnosis||||20260908120000||ACK^R01|3||2.3.1||||||UNICODE\rMSA|AA|\r", ack3)
    }
}
