...
/** iOS never hosts a support session; these answers only keep RemoteTools compiling in commonMain. */
actual fun platformRemoteToolPlatform(): RemoteToolPlatform = object : RemoteToolPlatform {
    ...
    override fun timezoneId(): String = kotlinx.datetime.TimeZone.currentSystemDefault().id
