...
private fun printRawViaSpooler(printerName: String, payload: ByteArray): String {
    ...
    return try {
        ...
        val attrs = HashPrintRequestAttributeSet().apply { add(JobName("BNM Diagnosis stickers", null)) }
...
private fun printRawViaCups(queue: String, payload: ByteArray): String {
    ...
    return try {
        ...
        val proc = ProcessBuilder("lp", "-d", queue, "-o", "raw", "-t", "BNM Diagnosis stickers", tmp.absolutePath)
